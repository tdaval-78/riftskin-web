-- Sync website account/admin schema into the main jfmr Supabase project

-- RiftSkin - Supabase username support
-- Run in Supabase SQL Editor for project jfmrwxmlncvzoremcmbi
...
exception
    when unique_violation then
        -- Duplicate username blocks sign-up as intended.
        raise;
end;
$$;
